...
CREATE TABLE `t_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1226129137234234482 DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_role` (
  ...
  `account_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4466666231884791529 DEFAULT CHARSET=utf8;
