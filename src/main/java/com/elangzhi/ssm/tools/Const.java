...
public class Const {
	 ...
	 * 不对匹配该值的访问路径拦截（正则）
	 */
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(api-docs)|(weixin)|(static)|(main)|(websocket)).*";
	 ...
	 * 发送验证码的手机号
	 */
	public static final String SECURITY_PHONE = "secPhone";
